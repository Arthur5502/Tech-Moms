...
import '../../styles/DashboardEmpresa/NavBarEmpresa.css';
import Sidebar from '../DashboardEmpresa/SideBarEmpresa';
    ...
    <div className="navbar-dash-container">
      ...
      <div className="navbar-dash">
        ...
        <div className="navbar-right-dash">
          ...
          <span>Nome Conta, <span className="empresa">Empresa</span></span>
